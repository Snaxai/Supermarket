...
public class EndShoppingEvent extends Event {
    ...
    public String toString() {
        return "EndShoppingEvent{"+ customer.name +  " | endShoppingTime:" + customer.endShoppingTime+
                " | Shopping duration: " + customer.shoppingDuration + " | QWD: " + customer.queueWaitDuration +
                " | leaveTime: " + customer.leaveTime + " | checkoutDur: " + customer.checkoutDuration +
